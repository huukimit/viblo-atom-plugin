...
export default {
    ...
    panels: [
        ...
        {
            id: PANEL_ID_POST_VIEW,
            hidden_in_menu: true,
            auth: true,
            creator: (options) => new PostViewPanel({hash_id: options.param})
        }
    ]
}
